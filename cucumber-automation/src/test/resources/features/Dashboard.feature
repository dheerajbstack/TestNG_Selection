...
Feature: Navigation and Dashboard Functionality
  ...
  @critical @TC001
  Scenario: TC001 - Application Loading and Navigation (1 TC)
  ...
  @high @TC002
  Scenario: TC002 - Dashboard Health Status Display (1 TC)
  ...
  @high @TC003
  Scenario: TC003 - Analytics Dashboard Functionality (1 TC)
